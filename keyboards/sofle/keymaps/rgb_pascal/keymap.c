 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ____ |Scrnsh| Close| Save |      |      |                    |      |      |  UP  |      | F12  | ____ |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ____ | Cut  | Copy | Paste| WH_U | PGUP | .------.  ,------. |      | LEFT | DOWN |RIGHT |      | ____ |
 * |------+------+------+------+------+------| | ____ |  | UPDN | |------+------+------+------+------+------|
 * | ____ | Undo | Redo | Lshft| WH_D | PGDN | '------'  '------' |      | HOME |      | END  |      | ____ |
 * `-----------------------------------------'  ________  _______ '-----------------------------------------'
 *               | LGui | LAlt | INTL |/LOWER| /       /  \      \RAISE \| RCTR |LOWER |  \|  |
 *               |      |      |      |      |/ Enter /    \Space \      \      |      |      |
 *               `-----------------------------------'     '------''------------'------'------'
...
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_SCRN,KC_CLOSE,KC_SAVE, KC_NO,   KC_NO,                      KC_NO,  KC_NO,   KC_UP,   KC_NO,   KC_F12, _______,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_CUT, KC_COPY, KC_PASTE,KC_WH_U, KC_PGUP,                    KC_NO,  KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,  _______,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,  KC_UNDO,KC_REDO, KC_LSFT, KC_WH_D, KC_PGDN,_______,   _______, KC_NO,  KC_HOME, KC_NO,   KC_END , KC_NO,  _______,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
