...
LT(_NUMPAD,KC_ESC),KC_1,KC_2,KC_3,    KC_4,    KC_5,             LT(_SWITCH,KC_6),   KC_7,   KC_8,    KC_9,    KC_0,   KC_DEL,
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_LCTRL, KC_SCLN,KC_Q,    KC_J,    KC_K,    KC_X,  KC_MPLY,    XXXXXXX,  KC_B,    KC_M,   KC_W,    KC_V,    KC_Z,   KC_BSLS,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_LGUI, KC_LALT, KC_INTL, KC_LOWER, KC_ENT,     KC_SPC, KC_RAISE, KC_RCTRL, KC_LOWER, KC_ENT
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
 ...
 * `-----------------------------------------'  ________  _______ '-----------------------------------------'
 *               | LGui | LAlt | INTL |/LOWER| /       /  \      \RAISE \| RCTR |LOWER | ____ |
 *               |      |      |      |      |/ Enter /    \Space \      \      |      |      |
 *               `-----------------------------------'     '------''------------'------'------'
 */
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,  KC_UNDO,KC_REDO, KC_LSFT, KC_WH_D, KC_PGDN,_______,   _______, KC_NO,  KC_HOME, KC_NO,   KC_END , KC_NO,  KC_NO,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
 ...
 * `-----------------------------------------'  ________  _______ '-----------------------------------------'
 *               |LCtrl | ???? | LAlt |/LOWER| /       /  \      \ RAISE\|   0  |   .  | ENTER |
 *               |      |      |      |      |/ Enter /    \Space \      \      |      |      |
 *               `-----------------------------------'     '------''------------'------'------'
 */
[_NUMPAD] = LAYOUT(
